...
echo "  Run: kubectl describe hr commoncal-core -n flux-system | grep -A5 'Release Metadata'"
...
echo "  Run: kubectl get pods -n commoncal -l app.kubernetes.io/instance=commoncal-core"
